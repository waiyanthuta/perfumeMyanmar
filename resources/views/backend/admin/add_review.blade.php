...
<section style="background-color: #eee;">
  <div class="container py-5">
    <div class="row justify-content-center">
      <form class="col-sm-6 col-md-6 col-lg-8 col-xl-8 m-4 mx-3 " action="{{route('backend.insert_review')}}" method="post" enctype="multipart/form-data">
          @csrf
            ...
            <div class="m-4">
              <div class="form-outline">
                ...
                @error('job')
                  <p class="text-danger font-weight-bold">{{$message}}</p>
                @enderror
                <input type="text" name="job" id="form6Example1" class="form-control" />
              </div>
            </div>
          ...
          <div class="card">
            <div class="m-4">
              <div class="form-outline">
                ...
                @error('headline')
                  <p class="text-danger font-weight-bold">{{$message}}</p>
                @enderror
                <input type="text" name="headline" id="form6Example1" class="form-control" />
              </div>
            </div>
            ...
            <div class="form-outline m-4">
              ...
              @error('review')
                <p class="text-danger font-weight-bold">{{$message}}</p>
              @enderror
              <textarea name="review" id="" class="form-control" cols="10" rows="3"></textarea>
            </div>
            ...
            <div class="m-4">
              ...
              @error('authorpic')
                <p class="text-danger font-weight-bold">{{$message}}</p>
              @enderror
              <input type="file" name="authorpic" class="form-control" id="customFile" /> <br>
            </div>
