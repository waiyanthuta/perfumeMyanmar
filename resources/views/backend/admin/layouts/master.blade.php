...
<head>
    ...
    <link href="{{asset('assets/backend/admin/css/sb-admin-2.min.css')}}" rel="stylesheet">
...
<script src="https://code.jquery.com/jquery-3.6.1.min.js"></script>
    ...
    <script type="text/javascript" src="{{asset('assets/backend/admin/vendor/jquery-easing/jquery.easing.min.js')}}"></script>
