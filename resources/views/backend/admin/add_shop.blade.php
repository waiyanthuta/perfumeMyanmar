...
<form class="col-md-8 m-4 mx-3 " style="display: inline-block; margin-left: 200px !important; " action="{{route('backend.insert_shop')}}" method="post" enctype="multipart/form-data">
    @csrf
